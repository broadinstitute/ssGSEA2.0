...
option_list <- list(
  ...
  make_option( c("-q", "--tolerate_min_overlap_error"), action='store', type='boolean',  dest='tolerate_min_overlap_error', help='Boolean to allow ssGSEA2() to tolerate input_ds having < min_overlap with gene_set_databases, without propogating error to shell.', default = FALSE),
